...
public abstract class Processor
	...
	static <T> T getParam(final HttpServletRequest request, final String name, Function<Optional<String>, T> parse) {
	...
	protected static <E extends Enum<E>> E getParam(final HttpServletRequest request, final String name,
		...
		return getParam(request, name, s -> s.map(String::toUpperCase).map(n -> Enum.valueOf(enumType, n)).orElse(null));
	}
